        ...
        return {
            [Symbol.iterator]: function* () {
                function* step(track, ordered) {
                    ...
                    for (let id of Array.from(orderedDependencies).reverse()) {
                        ...
                        yield [entityMap.get(id), id, true];

                        yield* step(track.concat(id), true);
                    }
                    ...
                    for (let id of unorderedDependencies) {
                        ...
                        yield [entityMap.get(id), id, undefined];
