                ...
                return regeneratorRuntime.wrap(function _callee$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                step = function step(track, ordered) {
                                    var previousId, orderedDependencies, unorderedDependencies, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, id, loopFirstIndex, errorInfo, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2;
                                    ...
                                    return regeneratorRuntime.wrap(function step$(_context) {
                                        while (1) {
                                            switch (_context.prev = _context.next) {
                                                ...
                                                case 19:
                                                    _context.next = 21;
                                                    return [entityMap.get(id), id, true];

                                                case 21:
                                                    return _context.delegateYield(step(track.concat(id), true), 't0', 22);
                                                ...
                                                case 48:
                                                    _context.next = 50;
                                                    return [entityMap.get(id), id, undefined];

                                                case 50:
                                                    return _context.delegateYield(step([id]), 't2', 51);
